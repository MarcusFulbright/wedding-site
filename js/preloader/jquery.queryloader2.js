...
OverlayLoader.prototype.createOverlay = function () {
	...
	//create title
	this.coupletitle = $("<div id='coupletitle'>dsfsdf</div>").appendTo(this.container);
	
	var thetitle = "<div class='container'>" + 
            			"<div class='row'>" +
							"<div class='col-md-12 text-center'>" +
								"<span id='loader_heart' class='glyphicon glyphicon-heart animated_heart'></span><br/>" +
								"<span id='hisname'>Marcus</span><br>" +
								"<span id='hername'>+ Stephanie</span><br>" +
							"</div>" +
						"</div>" +
					"</div>";	
						
	$('#coupletitle').html(thetitle);
